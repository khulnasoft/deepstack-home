...
description: How Airbus used Deepstack to build a combined table and text QA system for pilots, aircraft maintenance workers, and others
...
---	
Large language models (LLMs) are incredibly powerful, and we at khulnasoft are stoked about their seemingly limitless potential. But while models like Llama 2 and GPT-4 continue to make waves, a related but less buzzworthy technology has consistently been delivering great value for a range of use cases. 
...
If you want to see the results of such a system in action, [get started with Deepstack](https://deepstack.khulnasoft.com/overview/quick-start) today.

We’re always happy to see new members join our community of applied-NLP enthusiasts. Head over to our [community page](https://deepstack.khulnasoft.com/community) to join the khulnasoft Discord server or [find us on GitHub](https://github.com/khulnasoft/deepstack).