...
that will help you get started with Deepstack.
...
| Title                                                                                                                  | Type | Author                 | Description                                                                                                                   | Level    |
| ---------------------------------------------------------------------------------------------------------------------- | ---- | ---------------------- | ----------------------------------------------------------------------------------------------------------------------------- | -------- |
| [Question Answering at Scale With Deepstack](https://www.khulnasoft.com/blog/deepstack-question-answering-at-scale)          | Blog | Branden Chan (khulnasoft) | High level description of the Retriever-Reader pipeline that gives some intuition about how it works, how it can be deployed. | Beginner |
| [Understanding Semantic Search](https://www.khulnasoft.com/blog/understanding-semantic-search)                             | Blog | Branden Chan (khulnasoft) | Disambiguates search jargon and explains the differences between various styles of search.                                    | Beginner |
| [Deepstack: The State of Search in 2021](https://www.khulnasoft.com/blog/deepstack-the-state-of-search-in-2021)              | Blog | Branden Chan (khulnasoft) | Description of the Retriever-Reader pipeline and an introduction to some complementary tasks.                                 | Beginner |
| [Modern Question Answering Systems Explained](https://www.khulnasoft.com/blog/modern-question-answering-systems-explained) | Blog | Branden Chan (khulnasoft) | Illustrated deeper dive into the inner workings of the Reader model.                                                          | Beginner |
...
| Title                                                                                                                                  | Type | Author                 | Description                                                                                                | Level        |
| -------------------------------------------------------------------------------------------------------------------------------------- | ---- | ---------------------- | ---------------------------------------------------------------------------------------------------------- | ------------ |
| [What Is Text Vectorization? Everything You Need to Know](https://www.khulnasoft.com/blog/what-is-text-vectorization-in-nlp)               | Blog | Branden Chan (khulnasoft) | High-level overview of text vectorization starting from TF-IDF to Transformers.                            | Beginner     |
...
| Title                                                                                                                                                                             | Type          | Author          | Description                                                                                              | Level        |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | --------------- | -------------------------------------------------------------------------------------------------------- | ------------ |
| [From Language Model to Deepstack Reader](/pipeline_nodes/reader#deeper-dive-from-language-model-to-deepstack-reader)                                                               | Documentation | khulnasoft         | High level overview of how language models, Readers and prediction heads are all related                 | Beginner     |
