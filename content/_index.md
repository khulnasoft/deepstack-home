...
footer: light
title: Deepstack
description: Deepstack, the composable open-source AI framework

# Hero
hero:
  title: The Production-Ready<br/> Open Source AI Framework
  buttons:
    - buttonText: pip install deepstack-ai
    - buttonText: Get Started
      url: /overview/quick-start/

  features:
    - title: Highly<br> customizable
      highlightedText: Don’t just use Deepstack, build on top of it.
...
useCases:
  anchor: use-cases
  title: Deepstack Use Cases
  items:
    - title: Multimodal<br> AI
      text: Architect a next generation AI app around all modalities, not just text. Deepstack can do tasks like image generation, image captioning and audio transcription too.
    ...
    - title: Content<br> Generation
      text: The flexibility and composability of Deepstack’s prompt flow is unparalleled. Leverage our Jinja-2 templates and build a content generation engine that exactly matches your workflow.
    ...
    - title: Advanced<br> RAG
      text: Build highly performant RAG pipelines with a multitude of retrieval and generation strategies. From hybrid retrieval to self-correction loops, Deepstack has got you covered.
      icon: /images/icons/use-case-1.svg
...
community:
  ...
  discord:
    ...
    text: Our community on Discord is for everyone interested in NLP, using Deepstack or even just getting started!
    ctaText: GET STARTED
    url: https://discord.com/invite/VBpFzsgRVF
  newsletter:
    title: Sign up for<br> Deepstack updates
    text: Stay tuned for the latest Deepstack community news and events.
    inputPlaceholder: Enter your email
    buttonText: Subscribe
    successMessage: Thanks! You'll soon receive a confirmation email 📧

  communityTalks:
    - title: "AWS Summit Berlin 2023: Building Generative AI Applications on AWS featuring khulnasoft"
      videoId: Hns424sFY7s

    - title: Building Applications with LLM-Based Agents
      videoId: 1NPcnlqPf2U

    - title: "Open NLP Meetup #13: Hosting LLM Apps @ Scale with Deepstack, Titan ML & Jina AI"
      videoId: CWSn-9s955g
