---
layout: blog-post
title: "Enhancing RAG Pipelines in Deepstack: Introducing DiversityRanker and LostInTheMiddleRanker"
...
images: ["blog/enhancing-rag-pipelines-in-deepstack/thumbnail.png"]
...
authors:
  - Vladimir Blagojevic
canonical_url: https://towardsdatascience.com/enhancing-rag-pipelines-in-deepstack-45f14e2bc9f5
...
The new rankers are already merged into Deepstack’s main branch and will be available in the upcoming 1.20 release slated for the end of August 2023. We included a new LFQA/RAG pipeline demo in the project’s examples folder.
...
We’ve explored how Deepstack users can enhance their RAG pipelines by using two innovative rankers: DiversityRanker and LostInTheMiddleRanker.
...
We have demonstrated how these new rankers can potentially enhance Long-Form Question-Answering and other RAG pipelines. By continuing to invest in and expand on these and similar ideas, we can further improve the capabilities of Deepstack’s RAG pipelines, bringing us closer to crafting NLP solutions that seem more like magic than reality.
